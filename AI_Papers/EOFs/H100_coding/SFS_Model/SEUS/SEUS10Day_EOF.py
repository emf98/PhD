...
pickle.dump(sele_ind, open("SEUS2_SelectIndices_10days.p", 'wb'))
...
plt.title("Frequency of Selected PCs for 25 CVs of RF Model for SE US (10 Days)")
sele_ind1 = np.array(sele_ind)
sele_ind1 = sele_ind1.reshape(25*8)
plt.hist(sele_ind1, bins=np.arange(200))
plt.savefig('./images/SEUS2_10days_selefeature_hist.png')
