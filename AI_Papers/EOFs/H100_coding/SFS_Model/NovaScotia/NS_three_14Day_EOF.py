...
pickle.dump(sele_ind, open("Nova3_SelectIndices_14days.p", 'wb'))
...
plt.title("Frequency of Selected PCs for 25 CVs of RF Model for Nova Scotia (14 Days, 3 Classes)")
sele_ind1 = np.array(sele_ind)
sele_ind1 = sele_ind1.reshape(25*8)
plt.hist(sele_ind1, bins=np.arange(200))
plt.savefig('../images/Nova3_14days_selefeature_hist.png')
